      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">My Experience</h1>
            <p className="text-lg">A deeper dive into my work</p>
          </div>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <h3 className="h3">LTE Networks Engineer </h3>
                  <h4 className="h4 text-base text-gray-300 font-semibold mb-4">Co-op @ Teck Resources </h4>
                  ...
                  <ul className="text-medium text-gray-400 mb-2">
